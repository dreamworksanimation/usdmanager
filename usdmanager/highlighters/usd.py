    ...
    def getRules(self):
        return [
            ...
            [   # Keyword actions/descriptors
                ...
                r"\b(?:a(?:dd|ppend)|prepend|del(?:ete)?|custom|uniform|rel)\b",
                QtGui.QColor("#4b7029"),
                QtGui.QColor("#4b7029"),
                QtGui.QFont.Bold
            ],
            [   # Keywords
                ...
                # instanceable customData variant variants variantSets
                r"\b(?:references|payload|d(?:efaultPrim|oc)|s(?:ubLayers|pecializes)|a(?:ctive|ssetInfo)|hidden|kind|"
                r"in(?:herits|stanceable)|customData|variant(?:s|Sets)?)\b",
                QtGui.QColor("#649636"),
                QtGui.QColor("#649636"),
                QtGui.QFont.Bold
            ],
